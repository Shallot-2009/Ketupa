...
#  [Date]  Aug 8, 2025
#  [File name] Diff_Offset_Coplanar_Strips_1B1A
...
print(f"-------------------------------------------------------------------------------------------------")
tables=camelot.read_pdf('../input_files/Diff_Offset_Coplanar_Strips_1B1A.pdf' , pages='1', flavor='stream')
tables.export('../input_files/Diff_Offset_Coplanar_Strips_1B1A.csv',f='csv')

excel_file_path="../input_files/Diff_Offset_Coplanar_Strips_1B1A-page-1-table-1.csv"
sheet_name="Diff_Offset_Coplanar_Strips_1B1A"
# Read excel.
...
print(f"-------------------------------------------------------------------------------------------------")
############################################################################################################
Zdiff=df.iloc[11,2]       #Differential Impedance
...
clean_name = "Diff_Offset_Coplanar_Strips_1B1A"
...
oProject.InsertDesign("HFSS", "Diff_Offset_Coplanar_Strips_1B1A_(1)", "DrivenTerminal", "")
oDesign = oProject.SetActiveDesign("Diff_Offset_Coplanar_Strips_1B1A_(1)")
oProject.SaveAs(target_path_1/project_file_name, True)
#oProject.SaveAs("$PATH_DIR/HFSS_Projects/Diff_Offset_Coplanar_Strips_1B1A.aedt", True)
...
value7=df.iloc[6,2]           # Trace Separation
value8=df.iloc[10,2]          # Trace Thickness

value9 =df.iloc[7,2]          # Lower Ground Strip Width
value10=df.iloc[8,2]          # Upper Ground Strip Width
value11=df.iloc[9,2]          # Ground Strip Separation
