...
#  [Date]  Aug 8, 2025
#  [File name] Offset_Stripline_1B1A
#  [Notes]  The impedance is an Offset_Stripline of 50 ohm.
...
print(f"-------------------------------------------------------------------------------------------------")
tables=camelot.read_pdf('../input_files/Offset_Stripline_1B1A.pdf' , pages='1', flavor='stream')
tables.export('../input_files/Offset_Stripline_1B1A.csv',f='csv')

excel_file_path="../input_files/Offset_Stripline_1B1A-page-1-table-1.csv"
sheet_name="Offset_Stripline_1B1A"
# Read excel.
...
print(f"-------------------------------------------------------------------------------------------------")
############################################################################################################
Zdiff=df.iloc[7,2]       #Differential Impedance
...
clean_name = "Offset_Stripline_1B1A"
...
oProject.InsertDesign("HFSS", "Offset_Stripline_1B1A_(1)", "DrivenTerminal", "")
oDesign = oProject.SetActiveDesign("Offset_Stripline_1B1A_(1)")
oProject.SaveAs(target_path_1/project_file_name, True)
#oProject.SaveAs("$PATH_DIR/HFSS_Projects/Offset_Stripline_1B1A.aedt", True)
...
value8=df.iloc[6,2]           # Trace Thickness
...
oModule.CreateReport("Terminal S Parameter Plot 1", "Terminal Solution Data", "Rectangular Plot", "Setup1 : Sweep",
	...
	[
		"X Component:="		, "Freq",
		"Y Component:="		, ["dB(St(Offset_Stripline_T1,Offset_Stripline_T1))","dB(St(Offset_Stripline_T1,Offset_Stripline_T2))"]
	])
oModule.CreateReport("Terminal TDR Impedance Plot 1", "Terminal Solution Data", "Rectangular Plot", "Setup1 : Sweep",
	...
	[
		"X Component:="		, "Time",
		"Y Component:="		, ["TDRZt(Offset_Stripline_T1)"]
	])
