...
#  [Date]  Aug 8, 2025
#  [File name] Offset_Coplanar_Strips_1B1A
#  [Notes]  The impedance is an Offset_Coplanar_Stripline of 50 ohm.
...
print(f"-------------------------------------------------------------------------------------------------")
tables=camelot.read_pdf('../input_files/Offset_Coplanar_Strips_1B1A.pdf' , pages='1', flavor='stream')
tables.export('../input_files/Offset_Coplanar_Strips_1B1A.csv',f='csv')

excel_file_path="../input_files/Offset_Coplanar_Strips_1B1A-page-1-table-1.csv"
sheet_name="Offset_Coplanar_Strips_1B1A"
# Read excel.
...
print(f"-------------------------------------------------------------------------------------------------")
############################################################################################################
Zdiff=df.iloc[10,2]       #Differential Impedance
...
clean_name = "Offset_Coplanar_Strips_1B1A"
...
oProject.InsertDesign("HFSS", "Offset_Coplanar_Strips_1B1A_(1)", "DrivenTerminal", "")
oDesign = oProject.SetActiveDesign("Offset_Coplanar_Strips_1B1A_(1)")
oProject.SaveAs(target_path_1/project_file_name, True)
#oProject.SaveAs("$PATH_DIR/HFSS_Projects/Offset_Coplanar_Strips_1B1A.aedt", True)
...
value1=df.iloc[0,2]           # Substrate 1 Height
value2=df.iloc[1,2]           # Substrate 1 Dielectric
value3=df.iloc[2,2]           # Substrate 2 Height
value4=df.iloc[3,2]           # Substrate 2 Dielectric
value5=df.iloc[4,2]           # Lower Trace Width
value6=df.iloc[5,2]           # Upper Trace Width
value8=df.iloc[9,2]           # Trace Thickness

value9 =df.iloc[6,2]          # Lower Ground Strip Width
value10=df.iloc[7,2]          # Upper Ground Strip Width
value11=df.iloc[8,2]          # Ground Strip Separation
...
oEditor.ThickenSheet(
	[
		"NAME:Selections",
		"Selections:="		, "Offset_Coplanar_Strips",
...
oEditor.Subtract(
	[
		"NAME:Selections",
		"Blank Parts:="		, "pp",
		"Tool Parts:="		, "Offset_Coplanar_Strips"
	],
	[
...
oModule.AssignLengthOp(
	[
		...
		"RefineInside:="	, False,
		"Enabled:="		, True,
		"Objects:="		, ["Offset_Coplanar_Strips"],
		"RestrictElem:="	, False,
		"NumMaxElem:="		, "1000",
		"RestrictLength:="	, True,
		"MaxLength:="		, "0.1mm"
...
oModule.CreateReport("Terminal S Parameter Plot 1", "Terminal Solution Data", "Rectangular Plot", "Setup1 : Sweep",
	...
	[
		"X Component:="		, "Freq",
		"Y Component:="		, ["dB(St(Offset_Coplanar_Strips_T1,Offset_Coplanar_Strips_T1))","dB(St(Offset_Coplanar_Strips_T1,Offset_Coplanar_Strips_T2))"]
	])
oModule.CreateReport("Terminal TDR Impedance Plot 1", "Terminal Solution Data", "Rectangular Plot", "Setup1 : Sweep",
	...
	[
		"X Component:="		, "Time",
		"Y Component:="		, ["TDRZt(Offset_Coplanar_Strips_T1)"]
	])
