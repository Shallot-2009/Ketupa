...
oProject.InsertDesign "HFSS", "LogSpiralConical_Antenna_ADKv1", "DrivenModal", ""
Set oDesign = oProject.SetActiveDesign("LogSpiralConical_Antenna_ADKv1")
...
dim  solution_freq, NumberOfArms, InnerRadius, NumberOfTurns, OffsetAngle, ExpansionCoefficient, port_extension, ConeHeight, units, israd
...
Set oModule = oDesign.GetModule("BoundarySetup")  
oModule.AssignPerfectE Array("NAME:LogSpiralAntenna1", "Objects:=", Array("LogSpiralAntenna1"), "InfGroundPlane:=", false) 
...
vector_pointZ =  vector_pointZ & unit
