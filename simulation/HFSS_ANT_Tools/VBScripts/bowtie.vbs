...
oProject.InsertDesign "HFSS", "Bow_Tie_Antenna_ADKv1", "DrivenModal", ""
...
dim  solution_freq, Inner_Width, Outer_Width, Arm_Length, Port_Gap_Width, subH, subX, subY, units, israd
...
Material_Name = args(10)
Material_Name = Material_Name & "_ADK"
Permittivity = args(11)
TandD = args(12)
