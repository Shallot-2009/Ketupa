...
dim  solution_freq, patchX, patchY, subH, subX, subY, feedX, feedY, plateW, pin_rad, pin_outer, feed_length, units, israd
...
Array("NAME:--Shorting Plate", "PropType:=", "SeparatorProp", "UserDef:=", true, "Value:=", ""), _
Array("NAME:plateW", "PropType:=", "VariableProp", "UserDef:=", true, "Value:=", plateW & units), _
...
Set oEditor = oDesign.SetActiveEditor("3D Modeler")
  ...
  oEditor.CreateRectangle Array("NAME:RectangleParameters", "CoordinateSystemID:=",  _
  -1, "IsCovered:=", true, "XStart:=", "-patchX/2", "YStart:=", "-patchY/2", "ZStart:=",  _
  "0mm", "Width:=", "subH", "Height:=", "plateW", "WhichAxis:=", "Y"), Array("NAME:Attributes", "Name:=",  _
  "shorting_plate", "Flags:=", "", "Color:=", "(255 128 65)", "Transparency:=",  _
  0.3, "PartCoordinateSystem:=", "Global", "MaterialName:=",  _
  "pec", "SolveInside:=", false)
...
oModule.AssignPerfectE Array("NAME:shorting_plate", "Objects:=", Array("shorting_plate"), "InfGroundPlane:=", false)
