...
oProject.InsertDesign "HFSS", "ConicalHorn_Antenna_ADKv1", "DrivenModal", ""
Set oDesign = oProject.SetActiveDesign("ConicalHorn_Antenna_ADKv1")



dim  solution_freq, WG_Radius, WG_length, Horn_Radius, Horn_length, Wall_Thickness, units, israd
Locallang=getlocale()
...
Horn_Radius = CDbl(args(3))
Horn_length = CDbl(args(4))
Wall_Thickness = CDbl(args(5))
...
Array("NAME:Horn_Radius", "PropType:=", "VariableProp", "UserDef:=", true, "Value:=", Horn_Radius & units), _
...
oEditor.CreateCircle Array("NAME:CircleParameters", "CoordinateSystemID:=", -1, "IsCovered:=",  _
  true, "XCenter:=", "0mm", "YCenter:=", "0mm", "ZCenter:=", "Horn_length", "Radius:=",  _
  "Horn_Radius", "WhichAxis:=", "Z", "NumSegments:=", "0"), Array("NAME:Attributes", "Name:=",  _
...
oEditor.CreateCircle Array("NAME:CircleParameters", "CoordinateSystemID:=", -1, "IsCovered:=",  _
  true, "XCenter:=", "0mm", "YCenter:=", "0mm", "ZCenter:=", "Horn_length", "Radius:=",  _
  "Horn_Radius+Wall_Thickness", "WhichAxis:=", "Z", "NumSegments:=", "0"), Array("NAME:Attributes", "Name:=",  _
...
extent_x_pos = "Horn_Radius"
extent_x_neg = "-Horn_Radius"

extent_y_pos = "Horn_Radius"
extent_y_neg = "-Horn_Radius"
