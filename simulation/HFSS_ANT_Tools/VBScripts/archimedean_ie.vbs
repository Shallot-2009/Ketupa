...
oProject.InsertDesign "HFSS-IE", "Archimedean_Antenna_ADKv1", "DrivenModal", ""
Set oDesign = oProject.SetActiveDesign("Archimedean_Antenna_ADKv1")
...
dim  solution_freq, NumberOfArms, InnerRadius, NumberOfTurns, OffsetAngle, ExpansionCoefficient, SpiralCoefficient, subH, subX, subY, port_extension, units, israd
...
oEditor.SeparateBody Array("NAME:Selections", "Selections:=", "SpiralAntenna1", "NewPartsModelFlag:=",  _
  "Model")
...
Set oModule = oDesign.GetModule("BoundarySetup")  
oModule.AssignPerfectE Array("NAME:SpiralAntenna", "Objects:=", Array("SpiralAntenna1", "SpiralAntenna1_Separate1"))
...
oModule.AutoIdentifyTerminals Array("NAME:ReferenceConductors", "SpiralAntenna1_Separate1"),  _
  "p1", true
oModule.EditTerminal "SpiralAntenna1_T1", Array("NAME:SpiralAntenna1_T1", "ParentBndID:=",  _
...
start_vector_pointX = start_vector_pointX & units
   ...
   Set oModule = oDesign.GetModule("BoundarySetup")  
oModule.AssignPerfectE Array("NAME:SpiralAntenna_2", "Objects:=", Array("SpiralAntenna1_Separate2", "SpiralAntenna1_Separate3"))
