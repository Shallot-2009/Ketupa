...
oProject.InsertDesign "HFSS", "Horn1_Antenna_ADKv1", "DrivenModal", ""
Set oDesign = oProject.SetActiveDesign("Horn1_Antenna_ADKv1")



dim  solution_freq, a, b, WG_length, FlareA, FlareB, Horn_length, Wall_Thickness, units, israd
...
FlareA = CDbl( args(4))
FlareB = CDbl( args(5))
Horn_length = CDbl( args(6))
Wall_Thickness = CDbl( args(7))

units = args(8)

israd = args(9) ' 0 is for radiation surface, 1 is for PML
...
Array("NAME:FlareA", "PropType:=", "VariableProp", "UserDef:=", true, "Value:=", FlareA & units), _
Array("NAME:FlareB", "PropType:=", "VariableProp", "UserDef:=", true, "Value:=", FlareB & units), _
...
'' rectangle to be used for horn connect  
oEditor.CreateRectangle Array("NAME:RectangleParameters", "CoordinateSystemID:=",  _
  ...
  "0mm", "Width:=", "a", "Height:=", "b", "WhichAxis:=", "Z"), Array("NAME:Attributes", "Name:=",  _
...
''wall thickness  
oEditor.CreateRectangle Array("NAME:RectangleParameters", "CoordinateSystemID:=",  _
  -1, "IsCovered:=", true, "XStart:=", "-a/2-Wall_Thickness", "YStart:=", "-b/2-Wall_Thickness", "ZStart:=",  _
  "0mm", "Width:=", "a+2*Wall_Thickness", "Height:=", "b+2*Wall_Thickness", "WhichAxis:=", "Z"), Array("NAME:Attributes", "Name:=",  _
...
oEditor.CreateRectangle Array("NAME:RectangleParameters", "CoordinateSystemID:=",  _
  -1, "IsCovered:=", true, "XStart:=", "-FlareA/2", "YStart:=", "-FlareB/2", "ZStart:=",  _
  "Horn_length", "Width:=", "FlareA", "Height:=", "FlareB", "WhichAxis:=", "Z"), Array("NAME:Attributes", "Name:=",  _
  "Horn", "Flags:=", "", "Color:=", "(132 132 193)", "Transparency:=",  _
  0.8, "PartCoordinateSystem:=", "Global", "MaterialName:=",  _
  "vacuum", "SolveInside:=", true)   
  
oEditor.CreateRectangle Array("NAME:RectangleParameters", "CoordinateSystemID:=",  _
  -1, "IsCovered:=", true, "XStart:=", "-FlareA/2-Wall_Thickness", "YStart:=", "-FlareB/2-Wall_Thickness", "ZStart:=",  _
  "Horn_length", "Width:=", "FlareA+2*Wall_Thickness", "Height:=", "FlareB+2*Wall_Thickness", "WhichAxis:=", "Z"), Array("NAME:Attributes", "Name:=",  _
  "Horn_outer", "Flags:=", "", "Color:=", "(132 132 193)", "Transparency:=",  _
  0.8, "PartCoordinateSystem:=", "Global", "MaterialName:=",  _
  "pec", "SolveInside:=", false)    
...
extent_x_pos = "FlareA/2"
extent_x_neg = "-FlareA/2"

extent_y_pos = "FlareB/2"
extent_y_neg = "-FlareB/2"
