...
oModule.EditTerminal "port1_T1", Array("NAME:port1_T1", "ParentBndID:=", "Port1", "TerminalResistance:=",  _
  Zin & "ohm")
...
oEditor.CreateCylinder Array("NAME:CylinderParameters", "CoordinateSystemID:=", -1, "XCenter:=",  _
  "Helix_Diameter/2", "YCenter:=", "0", "ZCenter:=", " Number_of_Turns* Helix_Spacing", "Radius:=", "Wire_Diameter/2", "Height:=",  _
  "-Helix_Diameter", "WhichAxis:=", "X", "NumSides:=", "0"), Array("NAME:Attributes", "Name:=",  _
  "short1", "Flags:=", "", "Color:=", "(255 128 65)", "Transparency:=",  _
  0.8, "PartCoordinateSystem:=", "Global", "MaterialName:=",  _
  "pec", "SolveInside:=", false)
  
oEditor.CreateCylinder Array("NAME:CylinderParameters", "CoordinateSystemID:=", -1, "XCenter:=",  _
  "0", "YCenter:=", "Helix_Diameter/2", "ZCenter:=", "  Number_of_Turns* Helix_Spacing", "Radius:=", "-Wire_Diameter/2", "Height:=",  _
  "-Helix_Diameter", "WhichAxis:=", "Y", "NumSides:=", "0"), Array("NAME:Attributes", "Name:=",  _
  "short2", "Flags:=", "", "Color:=", "(255 128 65)", "Transparency:=",  _
  0.8, "PartCoordinateSystem:=", "Global", "MaterialName:=",  _
  "pec", "SolveInside:=", false)  

 if direction = 0 then
  oEditor.Rotate Array("NAME:Selections", "Selections:=", "short1,short2", "NewPartsModelFlag:=",  _
  "Model"), Array("NAME:RotateParameters", "RotateAxis:=", "Z", "RotateAngle:=",  _
  "-Number_Of_Turns*360deg")
 else
      oEditor.Rotate Array("NAME:Selections", "Selections:=", "short1,short2", "NewPartsModelFlag:=",  _
  "Model"), Array("NAME:RotateParameters", "RotateAxis:=", "Z", "RotateAngle:=",  _
  "Number_Of_Turns*360deg")
...
oEditor.Unite Array("NAME:Selections", "Selections:=",  _
  "feed_pin,feed_pin_1,feed_pin_2,feed_pin_3,short1,short2"), Array("NAME:UniteParameters", "KeepOriginals:=",  _
  false)



 Set oModule = oDesign.GetModule("Solutions")
oModule.EditSources Array("NAME:Sources", "port1_T1:=", Array(false, "1", "0deg"), "port1_T2:=", Array( _
  false, "1", "90deg"), "port1_T3:=", Array(false, "1", "180deg"), "port1_T4:=", Array( _
  false, "1", "270deg"))  
