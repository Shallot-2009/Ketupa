...
oProject.InsertDesign "HFSS-IE", "Slot_Antenna_ADKv1", "DrivenModal", ""
...
start_vector_pointY = start_vector_pointY & units
 ...
 edgeid =  oEditor.GetEdgeByPosition (Array("NAME:FaceParameters","BodyName:=", "port1", "XPosition:=", "-Antenna_Width/2", "YPosition:=","feed_offset", "ZPosition:=", "0"))
