...
## oDesktop.OpenProject("C:\\00_Asenjo\\00_Project\\Ketupa\\simulation\\Ansys_HFSS\\HFSS_Projects\\Wifi_patch_antenna.aedt")
## oProject = oDesktop.SetActiveProject("Wifi_patch_antenna")
...
##################################Save and Analyze##############################
oProject.SaveAs("C:\\00_Asenjo\\00_Project\\Ketupa\\simulation\\Ansys_HFSS\\HFSS_Projects\\Wifi_patch_antenna.aedt", True)
oDesign.AnalyzeAll()
##################################Create Reports################################
...
##################################Save Reports###########################################
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Terminal S Parameter Plot 1", "C:/00_Asenjo/00_Project/Ketupa/simulation/Ansys_HFSS/sim_results/Wifi_patch_antenna.csv", False)
oModule.ExportImageToFile("Terminal S Parameter Plot 1", "C:/00_Asenjo/00_Project/Ketupa/simulation/Ansys_HFSS/sim_results/Wifi_patch_antenna.bmp", 2030, 1102)
##################################Save s para############################################
oModule = oDesign.GetModule("Solutions")
oModule.ExportNetworkData("D=\'10um\' L=\'100um\' Lg=\'20um\' W=\'6um\'", ["Setup1:Sweep"], 3, "C:/00_Asenjo/00_Project/Ketupa/simulation/Ansys_HFSS/sim_results/Wifi_patch_antenna.s1p",
