...
#  [Date]  Jun 27, 2025
#  [File name]Edge_Fed_Rectangular_Patch_Antenna
#  [Notes]  Edge_Fed_Rectangular_Patch_Antenna
...
## oDesktop.OpenProject("C:\\00_Asenjo\\00_Project\\Ketupa\\simulation\\Ansys_HFSS\\HFSS_Projects\\Edge_Fed_Rectangular_Patch_Antenna.aedt")
## oProject = oDesktop.SetActiveProject("Edge_Fed_Rectangular_Patch_Antenna")
...
oEditor.CreateRectangle(
	[
		"NAME:RectangleParameters",
		"IsCovered:="		, True,
		"XStart:="		, "-EdgeFeedWidth/2",
		"YStart:="		, "0",
		"ZStart:="		, "subH",
		"Width:="		, "EdgeFeedWidth",
		"Height:="		, "patchY/2+EdgeFeedLength",
		"WhichAxis:="		, "Z"
	], 
	[
		"NAME:Attributes",
...
oEditor.CreateRectangle(
	[
		...
		"IsCovered:="		, True,
		"XStart:="		, "-FeedWidth/2",
		"YStart:="		, "patchY/2+EdgeFeedLength",
		"ZStart:="		, "subH",
		"Width:="		, "FeedWidth",
		"Height:="		, "FeedLength",
		"WhichAxis:="		, "Z"
...
oEditor.Unite(
	[
		"NAME:Selections",
		"Selections:="		, "patch,EdgeFeed,Feed"
	], 
	[
...
oEditor.CreateRectangle(
	[
		...
		"IsCovered:="		, True,
		"XStart:="		, "-FeedWidth/2",
		"YStart:="		, "patchY/2+EdgeFeedLength+FeedLength",
		"ZStart:="		, "0",
		"Width:="		, "subH",
		"Height:="		, "FeedWidth",
		"WhichAxis:="		, "Y"
...
oEditor.CreateEntityList(
	[
		...
		"EntityType:="		, "Face",
		"EntityList:="		, [130,131,132,133,134,135]
	], 
	[
		"NAME:Attributes",
		"Name:="		, "radFaces"
...
##################################Save and Analyze##############################
oProject.SaveAs("C:\\00_Asenjo\\00_Project\\Ketupa\\simulation\\Ansys_HFSS\\HFSS_Projects\\Edge_Fed_Rectangular_Patch_Antenna.aedt", True)
oDesign.AnalyzeAll()
##################################Create Reports################################
...
oModule.CreateReport("Terminal S Parameter Plot 1", "Terminal Solution Data", "Rectangular Plot", "Setup1 : Sweep",
	...
	[
		...
		"subX:="		, ["Nominal"],
		"subY:="		, ["Nominal"],
		"EdgeFeedWidth:="	, ["Nominal"],
		"EdgeFeedLength:="	, ["Nominal"],
		"FeedWidth:="		, ["Nominal"],
		"FeedLength:="		, ["Nominal"],
		"Airbox_dist:="		, ["Nominal"],
...
##################################Save Reports###########################################
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Terminal S Parameter Plot 2", "C:/00_Asenjo/00_Project/Ketupa/simulation/Ansys_HFSS/sim_results/Edge_Fed_Rectangular_Patch_Antenna.csv", False)
oModule.ExportImageToFile("Terminal S Parameter Plot 2", "C:/00_Asenjo/00_Project/Ketupa/simulation/Ansys_HFSS/sim_results/Edge_Fed_Rectangular_Patch_Antenna.bmp", 2030, 1102)
##################################Save s para############################################
oModule = oDesign.GetModule("Solutions")
oModule.ExportNetworkData("D=\'10um\' L=\'100um\' Lg=\'20um\' W=\'6um\'", ["Setup1:Sweep"], 3, "C:/00_Asenjo/00_Project/Ketupa/simulation/Ansys_HFSS/sim_results/Edge_Fed_Rectangular_Patch_Antenna.s1p",
