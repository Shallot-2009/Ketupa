...
## oDesktop.OpenProject("C:\\00_Asenjo\\00_Project\\Ketupa\\simulation\\Ansys_HFSS\\HFSS_Projects\\Inset_Fed_Elliptical_Patch_Antenna.aedt")
## oProject = oDesktop.SetActiveProject("Inset_Fed_Elliptical_Patch_Antenna")
oProject = oDesktop.NewProject()
oProject.InsertDesign("HFSS", "Elliptical_Patch_Antenna", "DrivenTerminal", "")
oDesign = oProject.SetActiveDesign("Elliptical_Patch_Antenna")
...
oEditor.CreateEntityList(
	[
		...
		"EntityType:="		, "Face",
		"EntityList:="		, [128,129,130,131,132,133]
	], 
	[
		"NAME:Attributes",
		"Name:="		, "radFaces"
...
##################################Save and Analyze##############################
oProject.SaveAs("C:\\00_Asenjo\\00_Project\\Ketupa\\simulation\\Ansys_HFSS\\HFSS_Projects\\Inset_Fed_Elliptical_Patch_Antenna.aedt", True)
oDesign.AnalyzeAll()
##################################Create Reports################################
...
##################################Save Reports###########################################
oModule = oDesign.GetModule("ReportSetup")
oModule.ExportToFile("Terminal S Parameter Plot 2", "C:/00_Asenjo/00_Project/Ketupa/simulation/Ansys_HFSS/sim_results/Inset_Fed_Elliptical_Patch_Antenna.csv", False)
oModule.ExportImageToFile("Terminal S Parameter Plot 2", "C:/00_Asenjo/00_Project/Ketupa/simulation/Ansys_HFSS/sim_results/Inset_Fed_Elliptical_Patch_Antenna.bmp", 2030, 1102)
##################################Save s para############################################
oModule = oDesign.GetModule("Solutions")
oModule.ExportNetworkData("D=\'10um\' L=\'100um\' Lg=\'20um\' W=\'6um\'", ["Setup1:Sweep"], 3, "C:/00_Asenjo/00_Project/Ketupa/simulation/Ansys_HFSS/sim_results/Inset_Fed_Elliptical_Patch_Antenna.s1p",
